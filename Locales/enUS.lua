local L = LibStub("AceLocale-3.0"):NewLocale("WorldQuestTab", "enUS", true)
...
L["PIN_SCALE"] = "Pin Scale Zone"
L["PIN_SCALE_CONTINENT"] = "Pin Scale Continent"
L["PIN_SCALE_TT"] = "Change the size of the zone map pins."
L["PIN_SCALE_CONTINENT_TT"] = "Change the size of the continent map pins."
